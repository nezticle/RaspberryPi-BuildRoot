...
define RSYSLOG_INSTALL_UPSTART_INIT_SCRIPT
	[ -f $(TARGET_DIR)/etc/init/rsyslog.conf ] || \
		$(INSTALL) -m 0644 -D package/rsyslog/rsyslog.conf \
			$(TARGET_DIR)/etc/init/rsyslog.conf
endef

define RSYSLOG_INSTALL_INIT_SCRIPT
...
ifeq ($(BR2_PACKAGE_UPSTART), y)
	RSYSLOG_POST_INSTALL_TARGET_HOOKS += RSYSLOG_INSTALL_UPSTART_INIT_SCRIPT
else
	RSYSLOG_POST_INSTALL_TARGET_HOOKS += RSYSLOG_INSTALL_INIT_SCRIPT
endif
